...
- legacy `AA/CA + ManagerForwardCall` write paths
...
- do not route user-side resonance writes through `ManagerForwardCall`
...
- Never route current user-side writes through `ManagerForwardCall`.
